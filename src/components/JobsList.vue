...
export default {
    ...
    methods: {
        getClosingDate(job, format) {
            ...
            return this.getDateAsString(job.ClosingDateUtc, job.ClosingDateUtcOffset, format);
        },
        ...
        getOpeningDate(job) {
            ...
            return this.getDateAsString(job.OpeningDateUtc, job.OpeningDateUtcOffset, DateFormat.Written);
        },
